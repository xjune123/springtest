package com.test.springtest.uniqueid;
...
public class SnowflakeIdWorker {
   ...
   public static SnowflakeIdWorker instance(){
      return new SnowflakeIdWorker(getPid() % 32, getMac() % 32);
   }
   ...
   public static void main(String[] args) {
      ...
      System.out.println("执行时间 " + clock.getNanoTime());
   }
}
